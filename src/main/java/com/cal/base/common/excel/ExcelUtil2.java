...
public class ExcelUtil2 {  
    ...
    public ExcelUtil2(String excelPath){  
     ...
     * @return 
     */  
    public ExcelUtil2 RestoreSettings(){  
        ExcelUtil2 instance = new  ExcelUtil2(this.excelPath);  
        return instance;  
    }  
     ...
     * @throws IOException 
     */  
    public List<String[]> readExcel(String xlsPath) throws IOException{  
     ...
     * @throws IOException 
     */  
    public List<String[]> readExcel_xlsx() throws IOException {  
     ...
     * @throws Exception 
     */  
    public List<String[]> readExcel_xlsx(String xlsPath) throws IOException {  
        // 判断文件是否存在  
        File file = new File(xlsPath);  
        if (!file.exists()) {  
     ...
     */  
    public List<String[]> readExcel_xls() throws IOException {  
     ...
     * @Date : 2014-9-11 上午09:53:21 
     */  
    public List<String[]> readExcel_xls(String xlsPath) throws IOException {  
...
//        	 XSSFWorkbook  wb2 = new XSSFWorkbook(new FileInputStream(file));
     ...
     * @return 
     */  
    private List<String[]> readExcel(Workbook wb) {
        List<String[]> rowList = new ArrayList<String[]>();  
        ...
        for(int t=startSheetIdx; t<sheetCount+endSheetIdx;t++){  
            ...
            for (int i = startReadPos; i <= lastRowNum + endReadPos; i++) {  
                ...
                if (row != null) {  
//                    rowList.add(row);  
                	String[] cell = new String[row.getLastCellNum()];
//                    out("第"+(i+1)+"行：",false);  
                     // 获取每一单元格的值  
