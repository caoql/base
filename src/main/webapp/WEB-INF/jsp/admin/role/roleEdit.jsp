				...
				<tbody>
					<tr>
						...
						<td><input name="name" type="text" placeholder="请输入角色名称" style="200px;"
							class="easyui-validatebox" data-options="required:true" value="${role.name}">
						</td>
					</tr>
					<tr>
						...
						<td><input name="description" type="text" style="200px;"
							...
							data-options="required:false" value="${role.description}"></td>
					</tr>
					<tr>
...
<script type="text/javascript">
	$(function() {
		...
		$('#btn-save').on('click', function() {
			...
			// 获取数据
			var formdata = $$.serializeToJson('#roleEditForm');
			if (!formdata) {
				return false;
			}
			// 发送请求处理
